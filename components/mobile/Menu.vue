<template>
  <nav
    class="sm:hidden duration-200 fixed top-0 w-full h-dvh z-30 bg-gradient-to-tr from-main-black-950 to-main-black-900"
  ...
  >
    ...
    <div class="w-full flex flex-col items-center py-3">
      ...
      <the-socials />
      <div class="flex items-center gap-2 text-main-black-200 mt-5">
        <p>
